...
if (!is_admin()) {
	...
	function load_styles() {
		...
		// Font Awesome - MOVE THIS TO SCRIPTS BELOW
		wp_register_script('font-awesome', '//use.fontawesome.com/e26559f234.js', array(), null, 'all', false);
		wp_enqueue_script('font-awesome');
		// HTML5Shiv - MOVE THIS TO SCRIPTS BELOW
		wp_enqueue_script( 'html5shiv', '//oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js' );
		wp_script_add_data( 'html5shiv', 'conditional', 'lt IE 9' );
		// Respond - MOVE THIS TO SCRIPTS BELOW
	...
	//	wp_enqueue_script('jquery-mobile');
		// Tether
		wp_register_script('tether', get_template_directory_uri() . '/js/tether.min.js', array('jquery'), null, true);
...
add_image_size( 'decorative-image', 1500, 650, false );
...
//
//
// ADD BASIC WYSIWYG EDITOR TO ACF
//
...
function my_toolbars( $toolbars )
{
	...
	*/
	...
	$toolbars['Very Simple' ][1] = array('formatselect', 'bold' , 'italic' , 'underline', 'bullist', 'numlist', 'link', 'unlink' );
...
// TESTIMONIALS
//
add_action( 'init', 'my_custom_post_unit' );
function my_custom_post_unit() {
	$labels = array(
		...
		'edit_item'          => __( 'Edit Units' ),
		'new_item'           => __( 'New Units' ),
		'all_items'          => __( 'All Units' ),
		'view_item'          => __( 'View all Units' ),
